...
final class Auth extends UserManager {
	...
	public function register($email, $password, $username = null, callable $callback = null) {
		$this->throttle([ 'enumerateUsers', $this->getIpAddress() ], 5, (60 * 60), 75);
		$this->throttle([ 'createNewAccount', $this->getIpAddress() ], 5, (60 * 60 * 12), 10, true);

		$newUserId = $this->createUserInternal(false, $email, $password, $username, $callback);

		$this->throttle([ 'createNewAccount', $this->getIpAddress() ], 5, (60 * 60 * 12), 10, false);
